    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pt-16 pb-24">
        ...
        <div className="flex justify-end mb-4">
          <button
            onClick={() => navigate(`/courses/${id}/learning-profile`)}
            className="flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-300 border border-white/5 hover:border-white/20 bg-white/[0.02] hover:bg-white/[0.05] px-3 py-1.5 rounded-lg transition-all"
          >
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
            Ver perfil de aprendizaje
          </button>
        </div>
